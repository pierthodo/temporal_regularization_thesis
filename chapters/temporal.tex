...
\subsection{Value based temporal regularization}
...
\begin{figure}
\begin{minipage}[c]{0.45\linewidth}
\includegraphics[width=\linewidth]{./fig/Exp_2.png}
